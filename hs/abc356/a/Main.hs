...
main :: IO ()
main = do
  (n, l, r) <- getLineToIntTuple3
  printArrayWithSpace $ solve n l r

solve :: Int -> Int -> Int -> [Int]
solve n l r =
  let !base = debugProxy $ [1 .. n]
      !left = debugProxy $ take (l -1) base
      !right = debugProxy $ drop r base
      !center = debugProxy $ reverse $ take (r - l + 1) . drop (l -1) $ base
