...
-- 二つの線分の座標が与えられた時、線分の被っている区間の長さを求める
solve :: [Int] -> Int
solve (l1 : r1 : l2 : r2 : _) =
  let line1 = debugProxy $ fromList [l1 .. r1]
      line2 = debugProxy $ fromList [l2 .. r2]
   in case size $ debugProxy $ intersection line1 line2 of
        0 -> 0
        a -> a - 1 -- 被っている部分の点間の長さなので-1
