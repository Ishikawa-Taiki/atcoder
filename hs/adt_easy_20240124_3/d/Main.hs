...
-- isInfixOf: 一つ目のリストが二つ目のリストに含まれているかを返す
-- https://hackage.haskell.org/package/base-4.19.0.0/docs/Data-List.html#v:isInfixOf
solve :: String -> Bool
solve xs = isInfixOf xs $ concat $ replicate (10 ^ 5) "oxx"
