...
main = do
  ...
  let updatedFt = add ft 2 (Sum 10) -- add 10 to 1-indexed position 2 (value at original index 1)
  ...
  let newSum0to2 = getSum $ query updatedFt 3
